...
//
// The type was renamed in SDK v0.5.0 to better reflect that mutations are applied
// to the response sent downstream to the client (not a response going upstream).
// Policies written against SDK ≤ v0.4.3 that return UpstreamResponseModifications
